...
${OBJECTDIR}/lib/libSwarmComm/src/common/clsTransmissionTimer.o: lib/libSwarmComm/src/common/clsTransmissionTimer.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmComm/src/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmComm/src/common/clsTransmissionTimer.o lib/libSwarmComm/src/common/clsTransmissionTimer.cpp
...
${OBJECTDIR}/lib/libSwarmCore/source/targets/WAMV/clsVehicle_WAMV_SIM.o: lib/libSwarmCore/source/targets/WAMV/clsVehicle_WAMV_SIM.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmCore/source/targets/WAMV
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmCore/source/targets/WAMV/clsVehicle_WAMV_SIM.o lib/libSwarmCore/source/targets/WAMV/clsVehicle_WAMV_SIM.cpp
...
${OBJECTDIR}/lib/libSwarmNet/source/common/clsBridgeLocal.o: lib/libSwarmNet/source/common/clsBridgeLocal.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmNet/source/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmNet/source/common/clsBridgeLocal.o lib/libSwarmNet/source/common/clsBridgeLocal.cpp

${OBJECTDIR}/lib/libSwarmNet/source/common/clsBridgeRemote.o: lib/libSwarmNet/source/common/clsBridgeRemote.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmNet/source/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmNet/source/common/clsBridgeRemote.o lib/libSwarmNet/source/common/clsBridgeRemote.cpp
...
${OBJECTDIR}/lib/libSwarmNet/source/common/clsMultiBridge.o: lib/libSwarmNet/source/common/clsMultiBridge.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmNet/source/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmNet/source/common/clsMultiBridge.o lib/libSwarmNet/source/common/clsMultiBridge.cpp
...
${OBJECTDIR}/lib/libSwarmSim/source/common/clsSwarm_DD_FullSim.o: lib/libSwarmSim/source/common/clsSwarm_DD_FullSim.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/libSwarmSim/source/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/libSwarmSim/source/common/clsSwarm_DD_FullSim.o lib/libSwarmSim/source/common/clsSwarm_DD_FullSim.cpp
